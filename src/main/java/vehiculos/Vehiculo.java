...
public class Vehiculo {
    ...
    public Vehiculo(String placa, int puertas, int velocidadMaxima, String nombre, int precio, int peso,
        ...
        if(ventasFabrica.containsKey(fabricante)){
            ventasFabrica.put(fabricante, ventasFabrica.get(fabricante)+1);
        }else{
    ...
    public void vehiculosPorTipo(){
        System.out.println("Automoviles: "+tiposVehiculos.get("Automovil")+"\n" + //
                "Camionetas: "+tiposVehiculos.get("Camioneta")+"\n" + //
                "Camiones: "+tiposVehiculos.get("Camion"));
    }
